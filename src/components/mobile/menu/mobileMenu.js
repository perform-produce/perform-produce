...
import { COLORS, MOBILE_GAP, MOBILE_LINE_HEIGHT, MOBILE_MENU_PADDING, MOBILE_VERT_GAP, MOBILE_STROKE_WIDTH } from '../../../constants/styleConstants'
...
const MenuContainer = styled.div`
  ...
  outline: black solid ${MOBILE_STROKE_WIDTH};
